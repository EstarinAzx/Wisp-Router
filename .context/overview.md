...
Released as terminal/npm 2.1.4 and Wisp VSIX 1.13.7, tag `v2.1.4` at `d3fcca6`: the native Codex `/v1/responses` subset and `codex-wisp` source/compiled/npm launchers. See `docs/codex-wisp.md` for invocation, routing, supported content/tools and retained checks. All five release jobs passed and published artifacts were verified. Installed Wisp 2.1.3 and extension 1.13.6 are unchanged; installation was not requested. [[active-work]] points to published downloads and verification evidence.
