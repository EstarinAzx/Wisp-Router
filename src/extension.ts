...
// Chat-surface context windows and vision are derived from the ACTIVE model id (catalog.contextForModel
// / modelSupportsVision), so they follow model switches — there are no per-row hints to keep in sync.
